      ...
      <div className="article-body">
        ...
        <figure className="fig">
          <img
            ...
            alt="Колаж із трьох знімків: озброєні люди в цивільному посеред пустелі, стрілець із кулеметом лежить перед шеренгою полонених, пікапи з кулеметами й четверо бійців зі зброєю. Обличчя на всіх кадрах затерті"
            style={{ width: "100%", display: "block" }}
          />
          <figcaption>
