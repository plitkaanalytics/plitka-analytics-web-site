    ...
    <main data-screen-label="Стаття · Африканська кампанія">
      ...
      <div className="article-body">
        ...
        <p>
          ...
          покликали «Вагнер»: угоду уклали наприкінці 2021-го, і, за оцінкою
          Держдепартаменту США, вона коштувала десять мільйонів доларів на
          місяць{" "}
          <a className="ref" href="#ref-18">
            [18]
          </a>
          . У 2023-му армія разом з росіянами взяла Кідаль — місто на півночі,
          яке майже десять років контролювали туарезькі сепаратисти. Ту перемогу
          вважали головним доказом, що російська модель працює
        ...
        <p>
          ...
          оточене алжирською територією. Бої тривали три дні. Коли колона почала
          відходити, її накрила піщана буря, а потім засідка
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>Армія Малі</td>
              <td>
                «Велика кількість» загиблих, без цифр; операція почалася 19
                липня, наступ — 25-го
                <a className="ref" href="#ref-42">
                  [42]
                </a>
        ...
        <p>
          ...
          Україною, звинувативши її в «підтримці міжнародного тероризму»
          <a className="ref" href="#ref-43">
            [43]
          </a>
          . 6 серпня те саме зробив Нігер{" "}
          <a className="ref" href="#ref-46">
            [46]
          </a>
        ...
        <p>
          Попри розрив, співпраця не припинилася — змінився тільки її розголос.
          25 квітня 2026 року туарезькі повстанці й повʼязані з аль-Каїдою
          угруповання одночасно вдарили по чотирьох містах, зокрема по Бамако, і
          захопили кілька військових баз на півночі. CNN називає їхній союз
          рідкісним, а сам наступ — найзухвалішим за понад десять років
          <a className="ref" href="#ref-40">
            [40]
          </a>
          . Міністра оборони Малі Садіо Камару, ключового архітектора повороту
          країни до Москви, убили підривом автомобіля біля його дому;
          відповідальність узяло JNIM
          <a className="ref" href="#ref-40">
            [40]
          </a>
          . Опинившись в оточенні в Кідалі, «Африканський корпус» домовився про
          безпечний коридор і пішов із міста — його відхід туареги зняли на
          відео, проводжаючи колону глузуванням{" "}
          <a className="ref" href="#ref-40">
            [40]
          </a>
          .
        ...
        <p>
          ...
          образу Москви як охоронця режимів
          <a className="ref" href="#ref-40">
            [40]
          </a>
