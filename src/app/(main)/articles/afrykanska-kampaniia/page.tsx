  ...
  return (
    <main data-screen-label="Стаття · Африканська кампанія">
      ...
      <div className="article-head">
        ...
        <p className="article-head__metaline">час читання 10 хв</p>
      ...
      <div className="article-body">
        ...
        <p>
          За рік розстановка змінилася. Росія, яка починала на боці RSF,
          перекинулася до армії аль-Бурхана — імовірно, заради морського
          доступу, вважають в RUSI
          <a className="ref" href="#ref-23">
            [23]
          </a>
          . У лютому 2025-го Хартум погодив Москві військово-морську базу біля
          Порт-Судана
          <a className="ref" href="#ref-21">
            [21]
          </a>
          , а наприкінці того ж року російський посол назвав проєкт призупиненим
          <a className="ref" href="#ref-18">
            [18]
          </a>
          . Carnegie описує теперішній стан просто: Кремль підтримує обидві
          сторони суданської війни
          <a className="ref" href="#ref-19">
            [19]
          </a>
          . Українські фахівці, за словами джерела в ГУР, із Судану нікуди не
          поділися
          <a className="ref" href="#ref-17">
            [17]
          </a>
