...
Для великого матеріалу (лонгріду) — ще й `docs/PROTSES-LONGRIDU.md`: окрема
гілка на статтю, повне скачування джерел до першого рядка тексту, написання
акт за актом і робота з покликаннями.
